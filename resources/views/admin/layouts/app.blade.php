...
<html lang="en">
	<head>
		...
		<title>WRT INDIA -Admin Panel</title>
		...
		{{-- Fav icon --}}
		<link rel="icon" href="{{asset('admin_assets/img/wrt.png')}}" type="image/x-icon">
	...
	<body class="hold-transition sidebar-mini">
		...
		<div class="wrapper">
			...
			<footer class="main-footer">
				...
				<strong> 2024 - Wrt India All rights reserved.
			</footer>
        ...
        <script type="text/javascript" src="{{ asset('admin_assets/ckeditor/adapters/jquery.js') }}"></script>
